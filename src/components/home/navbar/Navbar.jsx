...
function Navbar() {
    ...
    return (
        ...
        // responsive navbar
        // responsive navbar
        <div className="navbar bg-transparent w-11/12 mx-auto max-w-[1280px] zl-50">
            <div className="navbar-start">
                <div className="dropdown">
                    <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow bg-skyBlue-400 rounded-box w-52 space-y-4">
                ...
                <a className="btn btn-ghost text-xl">Peaceful Hotel</a>
            </div>
